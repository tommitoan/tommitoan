...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=16&pause=1000&color=58A6FF&center=true&vCenter=true&width=760&lines=Building+backend+systems+with+Go.;Microservices+%7C+gRPC+%7C+Protobuf+%7C+Event-driven+systems;Migrating+legacy+services+into+clean+Go+architecture.;Automating+developer+workflows+with+Copilot%2C+OpenCode+and+Claude." alt="Typing SVG" />
</p>
...
* 🔭 I’m a **Software Engineer** focused on **Go backend**, **microservices**, and **service migration**.
* 🧩 I work with **gRPC**, **Protobuf**, **gRPC-Gateway**, **REST APIs**, **Kafka**, and **RabbitMQ**.
* ☁️ I build and deploy services with **Docker**, **Kubernetes**, **AWS**, **GCP**, **Helm**, and **ArgoCD**.
* 📈 I care about production visibility with **Jaeger**, **Prometheus**, **Grafana**, **Loki**, and **VictoriaMetrics**.
* 🤖 I use **GitHub Copilot**, **OpenCode**, and **Claude** to speed up coding, refactoring, testing, and review.
